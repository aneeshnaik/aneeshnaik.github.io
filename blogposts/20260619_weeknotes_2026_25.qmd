...
Inspired by Guy Shrubsole's excellent book[^1] on the subject, I thought I would make a map of Britain's temperate rainforest by training a model with [TESSERA](https://geotessera.org/). 

[^1]: [The Lost Rainforests of Britain](https://lostrainforestsofbritain.org/). That site is the home not just of the book, but of Shrubsole's wider campaigning around the issue of temperate rainforests and their conservation.
...
![A first attempt at a map of temperate rainforest in Great Britain, produced with a classifier trained with TESSERA.](../assets/blogpost_images/20260619_rainforest.png){fig-align="center" fig-alt="A TESSERA-generated map of temperate rainforest in Great Britain" width="65%"}
...
I'll highlight one work in particular: [Spatial predictions at the community level](https://onlinelibrary.wiley.com/doi/abs/10.1111/brv.12222) by D'Amen et al. (2017)[^4], an excellent review published in Biological Reviews. Here, the authors describe three philosophies in community mapping:

[^4]: [D'Amen, M., Rahbek, C., Zimmermann, N.E. and Guisan, A. (2017). *Spatial predictions at the community level: from current approaches to future frameworks*. Biological Reviews.](https://onlinelibrary.wiley.com/doi/abs/10.1111/brv.12222)
...
My wife and I have been walking the [Borders Abbeys Way](https://www.scotlandsgreattrails.com/trail/borders-abbeys-way/) in stages. Last week we walked the ~22km stretch from Jedburgh to Hawick.[^5] This was rather nice, some excellent views from Black Law, and then a lovely stretch along the Teviot up to Hawick. We saw yellowhammers, dippers, and a mating pair of yellow wagtails. This was our first stretch of the Borders Abbeys Way with no (visible) goosanders.[^6]
