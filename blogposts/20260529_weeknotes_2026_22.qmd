---
title: "Week Notes: 2026 Week 22"
subtitle: "Week beginning Monday 25 May 2026"
date: 2026-05-29
---
...
![](../images/blogpost_images/20260529_cairngorms.png){fig-align="center" fig-alt="A habitat map of the Cairngorms" width="300px"}

::: {.aside}
A habitat map of the Cairngorms. Haven't included a legend, but suffice it to say that most things are heather, bog, or coniferous woodland (the Caledonian Forest!)
:::
...
![](../images/blogpost_images/20260529_bembo.png){fig-align="center" fig-alt="A research plan written in Bembo" width="600px"}

::: {.aside}
A research plan written in Bembo.
:::
...
![](../images/blogpost_images/20260529_lebw.png){fig-align="center" fig-alt="Predominantly English place names south of the Landsker line" width="300px"}

::: {.aside}
Predominantly English place names south of the Landsker line.
:::
...
I read a bunch of stuff around: agri-environment schemes, causal inference, and some of the older back-catalogue of papers around the "land sharing" versus "land sparing" debate.

::: {.aside}
Including many papers from [Andrew Balmford's group](https://www.zoo.cam.ac.uk/research/conservation-science/conservation-science) here at the Conservation Research Institute in Cambridge.
:::
...
Of course, the reality is not so much a binary as a spectrum. Nonetheless, evidence is beginning to accumulating in favour of approaches towards the land-sparing end of the spectrum. 
...
::: {.aside}
Wilhelm I (1864) quoted in 'What the Railways Did For Us', Stuart Hylton, (p15).
:::

Parts of the discussion struck a painfully familiar note:

> Partly as a result of all this process, Britain became the most expensive country in the world in which to get consent for a railway. Sometimes the parliamentary process alone could cost thousands of pounds a mile, added to which some landowners might extract quite exorbitant payments for their land as the price for removing their objections.

::: {.aside}
Discussion regarding spread of railways in mid-19th century Britain. Idem, (p19). I can't quite get over the gutting of HS2. Perhaps I'm reading this book a little too soon.
:::
...
![](../images/blogpost_images/20260529_crane.jpg){fig-align="center" fig-alt="Photograph of cranes at WWT Welney" width="500px"}

::: {.aside}
Cranes at WWT Welney. Not my photograph! Credit: WWT.
:::


I'm using a new ink: "Lie de Thé" by J. Herbin. As implied by the name, it's a beautiful deep-brown colour, I like it a lot.

![](../images/blogpost_images/20260529_ink.jpg){fig-align="center" fig-alt="Sample of my new ink" width="500px"}

::: {.aside}
Photograph of a sample of my new ink.
:::