...
::: {.aside}
In truth, this isn't really the archetypal use case for `datahues`: the map uses a series of discrete steps along the ramp, so would probably get away without strict perceptual uniformity.
:::
::: {.aside}
The map uses Met Office data licensed under the Open Government Licence v3.0. [Met Office (2025), *HadUK-Grid Gridded Climate Observations on a 1km grid over the UK, v1.3.1.ceda (1836-2024)*. NERC EDS Centre for Environmental Data Analysis.](https://catalogue.ceda.ac.uk/uuid/f02cc6ddd92f45b18b9ab6ab544df7d9)
:::
...
Our vegetable seedlings have had a bit of an adventure in May, they've travelled 800 miles and lived in four different houses. Now, they're finally in the ground in our garden in Edinburgh.
